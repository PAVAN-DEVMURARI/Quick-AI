...
import {Eraser, FileText, Sparkle} from 'lucide-react'
...
const ReviewResume = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      {/* right col */}
      <div className='w-full max-w-lg bg-white rounded-lg border border-gray-200 flex flex-col' style={{height: '600px'}}>
            <div className='flex items-center gap-3 p-4 border-b border-gray-100'>
              <FileText className='w-5 h-5 text-[#00DA83]' />
              <h1 className='text-xl font-semibold'>Analyse Resume</h1>
            </div>
